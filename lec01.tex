...
\begin{prop}[\(\varepsilon\)-Characterization of the Supremum]
{epsilon-supremum}
  Let \(A\subseteq\mathbb{R}\) be nonempty and let \(s\in\mathbb{R}\).
  Then \(s=\sup A\) if and only if
  \begin{enumerate}[nosep]
    \item \(s\) is an upper bound of \(A\); and
    \item for every \(\varepsilon>0\), \(s-\varepsilon\) is not an upper
      bound of \(A\).
  \end{enumerate}
  Equivalently,
  \[
    \forall\varepsilon>0,\quad
    \exists a\in A,\qquad s-\varepsilon<a\leq s.
  \]
\end{prop}
...
\begin{prop}[\(\varepsilon\)-Characterization of the Infimum]
{epsilon-infimum}
  Let \(A\subseteq\mathbb{R}\) be nonempty and let \(i\in\mathbb{R}\).
  Then \(i=\inf A\) if and only if
  \begin{enumerate}[nosep]
    \item \(i\) is a lower bound of \(A\); and
    \item for every \(\varepsilon>0\), \(i+\varepsilon\) is not a lower
      bound of \(A\).
  \end{enumerate}
  Equivalently,
  \[
    \forall\varepsilon>0,\quad
    \exists a\in A,\qquad i\leq a<i+\varepsilon.
  \]
\end{prop}
...
\begin{dfn}[Maximum]{maximum}
  A have a maximum $m = \max A$ if 
  \[
    \text{sup } A \in A 
  \] 
\end{dfn} 

\begin{dfn}[Minimum]{minimum}
  A have a minimum $m = \min A$ if 
  \[
    \text{inf } A \in A 
  \]
\end{dfn} 
...
\begin{dfn}[Complete Ordered Field]{complete-ordered-field}
  A \emph{complete ordered field} is a field \(F\) that is an ordered set and 
  Every nonempty set \(A\subseteq F\) that is \xref[bounded above]{def:bounded-above} has a 
\xref[least upper bound]{def:supremum} in \(F\) 
\end{dfn} 

\begin{axm}[Completeness Axiom]{completeness}
Every nonempty set \(A\subseteq\mathbb{R}\) that is \xref[bounded above]{def:bounded-above} has a 
\xref[least upper bound]{def:supremum} in \(\mathbb{R}\) 
\end{axm}

\begin{prop}[The Rational Numbers Are Not Complete]
{rationals-not-complete}
  The ordered field \(\mathbb{Q}\) is not complete. For example, the set
  \[
    A=\{q\in\mathbb{Q}:q^2<2\}
  \]
  is nonempty and bounded above in \(\mathbb{Q}\), but it has no supremum
  in \(\mathbb{Q}\).
\end{prop} 

\begin{rem}[Integers and Natural Numbers]{integers-naturals-not-fields}
  Neither \(\mathbb{Z}\) nor \(\mathbb{N}\) is a field, so neither can be
...
\begin{ex}
If $A = {\frac{1}{n}: n \in \mathbb N}$, then $\sup A = 1$ and $\inf A = 0$. Although it has a infimum, it does not have a minimum since $0 \notin A$. 
\end{ex} 

\begin{thm}[All Subsets of $\mathbb R$ have Supremums and Infimums]{supremum-infimum-existence}
  Every nonempty set \(A\subseteq\mathbb{R}\) that is \xref[bounded above]{def:bounded-above} has a 
\xref[least upper bound]{def:supremum} in \(\mathbb{R}\) and every nonempty set \(A\subseteq\mathbb{R}\) that is \xref[bounded below]{def:bounded-below} has a 
\xref[greatest lower bound]{def:infimum} in \(\mathbb{R}\) 
\end{thm} 

\begin{proof}[Bounded above in $\mathbb R$ implies exists a supremum in $\mathbb R$] 
  $A \subseteq \mathbb R$ and $A$ is \xref[bounded above]{def:bounded-above}. 
\end{proof}
